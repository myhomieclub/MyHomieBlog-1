...
{wx.uploadImage({
                ...
                {
                if (i==0) {
                $("#hid_pic2").val(serverId);//alert("1st");
                }
                if (i==1) {$("#hid_pic3").val(serverId);//alert("2nd");
                }

                }
                else if (chosenPicNum==2)
                {
                if (i==0){
                $("#hid_pic3").val(serverId);
                }
                }
                else {}
...
function chooseImage(){
    ...
    wx.chooseImage({
                   ...
                   {
                   $("#file_UserPic2").attr('src', localIds[0]);
                   $("#file_UserPic3").attr('src', localIds[1]);
                   }
                   else if (chosenPicNum==2)
                   {
...
<a href="#" onclick="chooseImage()">Choose Pics </a>
<br>
<div class="tubottom clearfloat fl">
<a href="#" onclick="clearPics()">Delete All Pics</a>
</div>
<ul>
<li><img onclick="preview(this)" id="file_UserPic1" src=""/></li>

<li><img onclick="preview(this)" id="file_UserPic2" src=""/></li>

<li><img onclick="preview(this)" id="file_UserPic3" src=""/></li>
</ul>
</div>
</div>

<div class="czhi clearfloat box-s" style="-webkit-user-select: text" id='diy_select_category'>
<p  class="dtit">Category</p>
...
<style>
.smallInput{
background:#ffffff;border-bottom-color:#ff6633;
