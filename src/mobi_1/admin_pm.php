...
<head>
    ...
    <title>Messages With User</title>
...
<div class="huifu clearfloat box-s">
    ...
    while ($row = mysql_fetch_array($res_msg, MYSQL_ASSOC)) {
        ...
        if ($msg_from == $userid) {
            ...
            <div class="list clearfloat fl">
                <?php if ($first == "true") {
                    echo "<p class=\"time\">$sent_time</p>";
                    $first = "false";
                } else if ($sent_time != $last_time) {
                    echo "<p class=\"time\">$sent_time</p>";
                    $last_time = $sent_time;
                } ?>
    ...
    $query_read = "update system_message set msg_read='1' where msg_from='$userid' and msg_to='system' and msg_read='0'";
...
<div class="hfctent clearfloat box-s" id="footer">
    <form action="admin_pm_action.php?userid=<?php echo $userid ?>" method="post">
